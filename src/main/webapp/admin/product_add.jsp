...
<section id="content" class="table-layout animated fadeIn">
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            ...
            1.表单提交方式必须是post
            2.表单项中必须有文件上传项，且必须有name和对应的值
            3.form表单 属性 enctype需要设置为multipart/form-data
           
           文件上传使用的是fileUpload组件,此时不能用<input type="hidden" name="method" value="save">，因为request.getParameter("method")接收不到,要用问号
             -->
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="sn" class="field">
                                    <input id="sn" name="pname" class="gui-input" placeholder="名称" type="text" value=""/>
                                </label>
                            </div>
                        </div>
						<div class="section row">
