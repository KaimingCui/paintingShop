                ...
                <form action="${pageContext.request.contextPath }/ProductServlet?method=update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="panel-body bg-light">
						...
						<div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="sn" class="field">
                                    <input id="sn" name="author" class="gui-input" placeholder="作者" type="text" value="${product.author}"/>
                            ...
                            <div class="col-md-6">
                                <label for="sn" class="field select">
                                    ...
                                    <c:forEach items = "${categoryList }" var = "c">
                                  	<option value="${c.cid }"  <c:if test="${c.cid == product.cid }">selected</c:if>>${c.cname}</option>
                          			</c:forEach>
                                    </select>
